...
// assuming that our site shows blog postings and that we have modelled a blog posting in astroboa
// this route specifies that the URL to see a blog posting is '/blogpostings/:blogpostingName' and that when this url arrives here
// it will be routed to a controller named 'BlogpostingsController' (remember the default suffix) and the method 'showBlogposting' will be called.
// The method will use the blog posting name to retrieve the blog posting from astroboa and then it will call a smarty template to
// show the blog posting. Pretty simple isn't it?
...
//this route is serving the request for displaying a collection of blog postings
...
// For the time being it routes to to the BlogpostingController
$route = new Route('/');
$route->setMapClass('Blogpostings')->setMapMethod('showBlogpostingCollection');
